...
from project3sever import search
class TestUpdateData(unittest.TestCase):
    ...
    def test_fuzzy_matching(self):
        city='沈阳'
        f = open("C:\\Users\\guoxiaoke\\Desktop\\NEU\\计算机课程\\python\\test\\new\\城市数据.txt",encoding='utf-8')  #
        data1=f.read()                             
        testcity=fuzzy_matching(data1,city)         #测试模糊匹配程序是否运行成功
        self.assertEqual(testcity,'沈阳')            #利用断言测试沈阳
        self.assertEqual(fuzzy_matching(data1,'这是一个没有被记录的城市'),-1)
